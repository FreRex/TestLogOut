...
const routes = [
    ...
    {
        path: 'auth',
        loadChildren: () => Promise.resolve().then(() => __importStar(require('./auth/auth.module'))).then(m => m.AuthPageModule)
    },
    {
        path: 'projects',
        loadChildren: () => Promise.resolve().then(() => __importStar(require('./projects/projects.module'))).then(m => m.ProjectsPageModule),
