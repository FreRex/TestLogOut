...
export class TestMapPage implements OnInit {
  ...
  ngOnInit() {
    ...
    new Map({
      ...
      layers: [
        ...
        new LayerGroup({
            ...
            layers: [
              ...
              new TileLayer({
                ...
                type: 'base',       					
                visible: false,
                source: new XYZ({url: 'http://mt1.googleapis.com/vt?x={x}&y={y}&z={z}'})
              }),
              new TileLayer({
              ...
              new TileLayer({
                title: 'Google satellite',
       					type: 'base',       					
       					visible: true,
       					source: new XYZ({url: 'http://mt0.google.com/vt/lyrs=s&hl=en&x={x}&y={y}&z={z}?key=AIzaSyAfSMp-syOQXDlulMxr14XIV4-hgOt2DRc'})
              }),
              new TileLayer({
                title: 'Nessuno',
       					type: 'base',       					
        ...
        new LayerGroup({
            ...
            layers: [
              new TileLayer({ 
                title: 'Nodi fisici',                
                source: new TileWMS({url: 'https://www.collaudolive.com:9080/geoserver/CollaudoLiveGisfo/wms',
      ...
      view: new View({center: olProj.transform([longcentrmap, latcentromap], 'EPSG:4326', 'EPSG:3857'), zoom: 15})
    });
